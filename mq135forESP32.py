"""
Modified July 02 2020 for ESP32-Wroom-NodeMCU by Divergentti
See #-comments
...
import math
import time
from machine import Pin # ADC0 = Pin36
...
class MQ135(object):
    ...
    def get_resistance(self):
        ...
        return (4095./value - 1.) * self.RLOAD  # ESP32 maximum is 4095
...
def mq135lib_example():
    ...
    mq135 = MQ135(Pin(36))  # ESP32 ADC0

    # loop
    while True:
        # not really needed, but if not in try: except, math gives error if get_resistance returns wrong values
        try:
